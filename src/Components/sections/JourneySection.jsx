...
const Styles = {
  ...
  Journeygrid: "grid md:grid-cols-2 lg:grid-cols-3 gap-10 text-center",
  Card : "bg-white rounded-xl shadow-lg overflow-hidden hover:-translate-y-2 transition p-6 border",
  year :"font-extrabold text-gray-400 text-3xl md:text-4xl mb-4",
